...
namespace Rock_Scissors_Paper
{
    class Server
    {
        ...
        private static void HandleSpecialMoves()
        {
            ...
            {
                SendToBothPlayers("One player offered a draw. Waiting for opponent's response...");
            }
        }
        ...
        private static string DetermineWinner()
        {
            if (player1Choice == "Draw" || player2Choice == "Draw")
            {
                ...
                return "One player offered a draw. Waiting for opponent's response...";
            }
